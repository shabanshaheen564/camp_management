    ...
    <div class="map-wrapper position-relative">
        ...
        <div id="map">
            <div class="map-legend-box">
                <div class="ml-item">
                    <div class="ml-dot" style="background:#2563eb"></div> مخيم
                </div>
                <div class="ml-item">
                    <div class="ml-dot" style="background:#dc2626"></div> مستشفى
                </div>
                <div class="ml-item">
                    <div class="ml-sq" style="background:#22c55e"></div> مناطق ممتازة (gridcode 1)
                </div>
                <div class="ml-item">
                    <div class="ml-sq" style="background:#f59e0b"></div> مناطق جيدة (gridcode 2)
                </div>
                <div class="ml-item">
                    <div class="ml-sq" style="background:transparent;border:2px dashed #1d4ed8;width:14px;height:11px">
                    </div> حدود منطقة الدراسة
                </div>
                <div class="ml-item">
                    <div class="ml-dot" style="background:#f59e0b"></div> مسار داخل منطقة الدراسة
                </div>
                <div class="ml-item">
                    <div class="ml-dot" style="background:#ef4444"></div> خارج منطقة الدراسة
                </div>
            </div>
        </div>
        ...
        <div class="side-panel">
            ...
            <div class="panel-tabs">
                ...
                <button class="ptab" onclick="switchTab('analysis')"><i class="fas fa-chart-bar"></i> تحليل مسارات مستشفى
                </button>
            ...
            <div id="tab-layers" class="panel-body">
                ...
                <div class="mb-2">
                    <label class="form-label" style="font-size:11px;color:#64748b;display:block;margin-bottom:4px">ملف حدود
                        منطقة الدراسة</label>
                    <select id="study-area-file" class="form-select form-select-sm"
                        onchange="setSelectedShapefile('study', this.value)" disabled>
                        <option value="">اختر ملفًا</option>
                    </select>
                </div>
                <div class="mb-2">
                    <label class="form-label" style="font-size:11px;color:#64748b;display:block;margin-bottom:4px">ملف أفضل
                        المواقع</label>
                    <select id="best-site-file" class="form-select form-select-sm"
                        onchange="setSelectedShapefile('bestSite', this.value)" disabled>
                        <option value="">اختر ملفًا</option>
                    </select>
                </div>
                ...
                <div class="layer-legend" id="layer-controls" style="display:none">
                    ...
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" id="toggle-study" checked
                            onchange="toggleLayer('study', this.checked)">
                        <label class="form-check-label" style="font-size:12px" for="toggle-study">
                            <span class="legend-swatch d-inline-block"
                                style="background:#2563eb;width:14px;height:10px;border-radius:2px;vertical-align:middle;margin-left:4px"></span>
                            حدود منطقة الدراسة
                        </label>
                    </div>
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" id="toggle-best" checked
                            onchange="toggleLayer('best', this.checked)">
                        <label class="form-check-label" style="font-size:12px" for="toggle-best">
                            <span class="legend-swatch d-inline-block"
                                style="background:#22c55e;width:14px;height:10px;border-radius:2px;vertical-align:middle;margin-left:4px"></span>
                            مناطق ممتازة (gridcode 1)
                        </label>
                    </div>
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" id="toggle-good" checked
                            onchange="toggleLayer('good', this.checked)">
                        <label class="form-check-label" style="font-size:12px" for="toggle-good">
                            <span class="legend-swatch d-inline-block"
                                style="background:#f59e0b;width:14px;height:10px;border-radius:2px;vertical-align:middle;margin-left:4px"></span>
                            مناطق جيدة (gridcode 2)
                        </label>
                    </div>
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="toggle-camps" checked
                            onchange="toggleCamps(this.checked)">
                        <label class="form-check-label" style="font-size:12px" for="toggle-camps">
                            <span
                                style="background:#2563eb;width:10px;height:10px;border-radius:50%;display:inline-block;vertical-align:middle;margin-left:4px"></span>
                            المخيمات
                        </label>
                    </div>
                </div>
            ...
            <div id="tab-hospitals" class="panel-body" style="display:none">
                <div class="add-section">
                    ...
                    <div class="mb-2"><input type="text" id="h-name" class="form-control form-control-sm"
                            placeholder="اسم المستشفى *"></div>
                    <div class="row g-2 mb-2">
                        <div class="col-6"><input type="number" id="h-lat" class="form-control form-control-sm"
                                placeholder="خط العرض" step="any"></div>
                        <div class="col-6"><input type="number" id="h-lng" class="form-control form-control-sm"
                                placeholder="خط الطول" step="any"></div>
                    </div>
                    <div class="row g-2 mb-2">
                        <div class="col-7"><input type="text" id="h-phone" class="form-control form-control-sm"
                                placeholder="هاتف (اختياري)"></div>
                        <div class="col-5">
            ...
            <div id="tab-relocation" class="panel-body" style="display:none">
                ...
                {{-- Settings Card --}}
                <div
                    style="background:#f8fafc;border-radius:12px;padding:12px;margin-bottom:12px;border:1.5px solid #e2e8f0">
                    ...
                    <div class="mb-2">
                        <label style="font-size:11px;color:#64748b;display:block;margin-bottom:3px">الحد الأدنى للمساحة
                            (دونم)</label>
                        <input type="number" id="rel-min-area" class="form-control form-control-sm" value="1" min="0.1"
                            step="0.1">
                    </div>

                    <div class="mb-2">
                        <label style="font-size:11px;color:#64748b;display:block;margin-bottom:3px">الحد الأقصى للمسافة من
                            مستشفى (كم)</label>
                        <input type="number" id="rel-max-hosp" class="form-control form-control-sm" value="10" min="0.5"
                            step="0.5">
                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        function getSelectedBestSiteFeatures() {
            ...
            const features = selected ? (selected.features || []) : getAllFeatures();
            return (features || []).filter(feat => {
                const gc = parseInt(feat.properties.gridcode ?? feat.properties.GRIDCODE ?? -1, 10);
                return gc === 1 || gc === 2;
            });
        }
        ...
        function setSelectedShapefile(type, id) {
            ...
            if (type === 'bestSite') {
                selectedBestSiteFileId = id;
                const selected = uploadedShapefiles.find(item => item.id === id);
                if (selected?.features?.length) {
                    geoLayers.best.clearLayers();
                    geoLayers.good.clearLayers();
                    loadGeoJSON({ type: 'FeatureCollection', features: selected.features }, selected.name);
                }
            }
        }
        ...
        function loadGeoJSON(geojson, fileName = '') {
            ...
            features.forEach(feat => {
                const rawGc = feat.properties.gridcode ?? feat.properties.GRIDCODE;
                const gc = parseInt(rawGc, 10);
                if (![1, 2].includes(gc)) return;
                ...
                if (gc === 1) {
                    geoLayers.best.addLayer(poly);
                } else if (gc === 2) {
                    geoLayers.good.addLayer(poly);
                }
            });

            const bestToggle = document.getElementById('toggle-best');
            const goodToggle = document.getElementById('toggle-good');
            if (bestToggle?.checked) geoLayers.best.addTo(map);
            if (goodToggle?.checked) geoLayers.good.addTo(map);
            const bounds = L.geoJSON({ type: 'FeatureCollection', features: features.filter(feat => {
                const gc = parseInt(feat.properties.gridcode ?? feat.properties.GRIDCODE ?? -1, 10);
                return gc === 1 || gc === 2;
            }) }).getBounds();
